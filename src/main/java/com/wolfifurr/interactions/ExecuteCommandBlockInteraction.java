...
public class ExecuteCommandBlockInteraction extends SimpleBlockInteraction {
    ...
    static {
        CODEC = BuilderCodec.builder(ExecuteCommandBlockInteraction.class, ExecuteCommandBlockInteraction::new, SimpleBlockInteraction.CODEC)
